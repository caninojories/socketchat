...
strategy.facebook = new FacebookStrategy({
  ...
  User.findOrCreate({
    ...
    providerID: profile.id, // This is the id of this user in facebook.
    provider: provider.provider, // (this column is to know how they login, using facebook or twitter or something else).
